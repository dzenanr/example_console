...
fibonacci1(DartConsole dartConsole) {
  ...
  dartConsole.sline('Fibonacci with iteration: $count');
...
fibonacci2(DartConsole dartConsole) {
  ...
  dartConsole.sline('Fibonacci with recursion: $count');
  dartConsole.line('$result');
}
...
fibonacci3(DartConsole dartConsole) {
  ...
  dartConsole.sline('Fibonacci with recursion and map: $count');
...
fibonacci4(DartConsole dartConsole) {
  ...
  dartConsole.sline('Fibonacci with recursion, map and closure: $count');
  map.forEach((k,v) => dartConsole.line('$k: $v'));
}
